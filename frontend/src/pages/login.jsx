...
const Login = () => {
  ...
  useEffect(() => {
    if (successMessage && isAuthenticated && user) {
      ...
      if (userRole === "admin") {
        ...
        // For regular users, send them to the marketplace or user dashboard
        navigate("/");
      }
    }
  ...
  }, [isAuthenticated, user, dispatch, successMessage, error, navigate]);
