...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="lg:w-6/10 bg-gradient-to-br from-[hsl(var(--auth-gradient-start))] to-[hsl(var(--auth-gradient-end))] flex justify-end">
        <h1 className="text-4xl font-bold text-text-black mb-8 text-right relative top-27 mr-10 h-[100px]">
      ...
      <div className="w-4/10 flex items-center justify-center p-8 py-0 rounded-tl-3xl rounded-bl-3xl border">
