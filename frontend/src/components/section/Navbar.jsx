    ...
    <>
      <nav
        className={`shadow-sm sticky top-0 z-50 ${
          isScrolled ? "bg-text-muted" : "bg-transparent"
        }`}
      >
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-white text-black shadow-lg transition-all duration-300 hover:bg-gray-200
        ${
          isScrolled
