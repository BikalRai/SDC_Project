        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 mt-6 md:mt-8 lg:mt-12">
          ...
          <div className="bg-background p-10 grid gap-10 lg:gap-52 rounded-xl">
            <div className="grid gap-5">
              <h3 className="relative text-base md:text-lg lg:text-2xl font-bold text-primary">
                How it started?
                <span className="absolute left-0 -bottom-1 h-[3px] w-full bg-primary rounded-full"></span>
              </h3>

              <h1 className="text-2xl md:text-3xl lg:text-5xl font-extrabold leading-10 lg:leading-[64px] tracking-tight drop-shadow-lg text-right">
                <span className="text-primary">Our vision</span> is to redefine
                the way people rent
              </h1>
            </div>
            <p className="text-sm lg:text-base text-justify">
              ...
              lend anything — from clothes and furniture to bikes and cars — all
              in one trusted space. With dedication and passion, our team
              continues to make sharing easier, promoting a lifestyle that
              values convenience, community, and care for the environment.
            </p>
          </div>
